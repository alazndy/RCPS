 ...
 * ---------------------------------------------------------------------------------
 * Versiyon: v3.1.2 (Haberleşme Protokolü Düzeltmesi)
 * Yazar:    G.T
 * Tarih:    14.11.2025
 *
 * --- v3.1.2 Değişiklik Notları ---
 * - DÜZELTME (Kritik): 'handleNextionInput()' fonksiyonu, v3.0.0'dan beri var olan
 *             ve SAVE, SETPASS gibi komutların işlenmesini engelleyen mantık hatasını
 *             gidermek için, v2.5.1'deki daha basit ve stabil yapıya geri
 *             döndürüldü ve yeni komutlarla (SAVE1, SAVE2, RESETALL vb.) genişletildi.
 *             Bu, ayarların tekrar kaydedilebilmesini sağlar.
 * - KONTROL: Yatay konumlandırma (`targetX_px`) hesaplamasının doğruluğu teyit edildi.
 * =================================================================================
 */
...
void setup() {
  ...
  Serial.println("\n-- Radar Alıcısı Başlatılıyor (v3.1.2 - Düzeltilmiş) --");
...
// ======================= NEXTION GİRİŞ İŞLEME (DÜZELTİLDİ) =======================
