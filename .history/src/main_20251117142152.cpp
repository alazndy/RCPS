 ...
 * ---------------------------------------------------------------------------------
 * Versiyon: v3.0.2 (Kritik Linker Düzeltmesi)
 * Yazar:    G.T
 * Tarih:    14.11.2025
 *
 * --- v3.0.2 Değişiklik Notları ---
 * - DÜZELTME (Kritik): Eksik olan 'sendCommand(String)' fonksiyonunun gövdesi koda
 *             eklendi. Bu, "undefined reference" linker hatasını giderir.
 * =================================================================================
 */
...
void setup() {
  ...
  Serial.println("\n-- Radar Alıcısı Başlatılıyor (v3.0.2 - Düzeltilmiş) --");
